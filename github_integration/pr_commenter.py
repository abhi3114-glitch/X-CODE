...
class PRCommenter:
    ...
    def _format_inline_comment(self, issue: Dict[str, Any]) -> str:
        ...
        emoji = severity_emoji.get(issue.get('severity', 'medium'), '⚠️')
        category = issue.get('category', issue.get('type', 'issue'))
        message = issue.get('message', 'No description')
        suggestion = issue.get('suggestion', '')
        auto_fix = issue.get('auto_fix', '')
        
        comment = f"{emoji} **{category.upper()}** ({issue.get('severity', 'medium')})\n\n"
        comment += f"{message}\n\n"
        ...
        comment += "*🤖 Generated by CODEX AI Code Review Assistant*"
    ...
    def _create_review_summary(self, pr_info: Dict[str, Any], 
        ...
        summary = f"## 🤖 CODEX AI Code Review\n\n"
        ...
        summary += "---\n"
        summary += "*Powered by OpenAI GPT-4 + Static Analysis Tools*"
