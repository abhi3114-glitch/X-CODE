...
2. **Create Heroku app**
```bash
heroku create codex-review-bot
```
...
5. **Update webhook URL**
   - Use your Heroku app URL: `https://codex-review-bot.herokuapp.com/webhook`
...
2. **Build and run**
```bash
docker build -t codex-bot .
docker run -p 5000:5000 --env-file .env codex-bot
```

## 🎯 Usage

Once configured, CODEX automatically reviews PRs:

1. **Open a Pull Request** in your repository
2. **CODEX triggers** and analyzes the changes
...
🤖 Generated by CODEX AI Code Review Assistant
```
